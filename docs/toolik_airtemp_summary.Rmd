...
# If you're reading in giant datasets, use data.table::fread()
```
...
# cmd + shift + m gives you the pipe operator 
# it is the sequence that I want to do stuff in and any step is applied to the outcome of the previous step. 
